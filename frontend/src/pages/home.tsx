  ...
  return (
    <>
      ...
      <main className="mt-[60px]">
        ...
        {/* CTA Section */}
        <section className="py-16 md:py-20 bg-[#F7FAEF]">
          <div className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="relative rounded-3xl overflow-hidden bg-[#2D1E0F] px-8 py-12 md:px-14 md:py-16 shadow-2xl">
              {/* Decorativo */}
              <div className="absolute top-0 right-0 w-80 h-80 rounded-full opacity-10 -translate-y-1/2 translate-x-1/3 bg-[#E0B13C]" />
              <div className="absolute bottom-0 left-0 w-56 h-56 rounded-full opacity-10 translate-y-1/2 -translate-x-1/3 bg-[#8B4F23]" />

              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left">
                  <span className="text-xs font-bold uppercase tracking-widest text-[#E0B13C]">Reservas abertas</span>
                  <h2 className="mt-2 text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                  <Link
                    to="/reservar"
                    className="inline-flex items-center justify-center gap-2 bg-[#8B4F23] text-white font-bold px-8 py-4 rounded-full shadow-lg hover:bg-[#A05D2B] transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5 text-sm whitespace-nowrap"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 border border-white/20 text-white font-medium px-8 py-4 rounded-full hover:bg-white/10 transition-all duration-200 text-sm whitespace-nowrap"
                  >
